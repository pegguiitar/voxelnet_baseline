"""train.py (exp1_single_stage_bev) - trains SparseBEVSingleStageVoxelNet.
...
Usage:
    ...
    python train.py --ckpt_dir checkpoints_exp1_single_stage_bev --resume checkpoints_exp1_single_stage_bev/last.pth
"""
import argparse
import csv
import sys
...
def main():
    ...
    parser.add_argument("--ckpt_dir", default="checkpoints_exp1_single_stage_bev")
