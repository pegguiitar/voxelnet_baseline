"""smoke_test.py (exp1_single_stage_bev) - synthetic-data structural test for
SparseBEVSingleStageVoxelNet (model construction -> forward -> BEV target building
...
def main():
    ...
    print("\nOK -- exp1_single_stage_bev forward/target/loss/backward/decode all ran without error.")
