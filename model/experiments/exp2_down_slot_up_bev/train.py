"""train.py (exp2_down_slot_up_bev) - trains SparseBEVDownSlotUpVoxelNet.
...
Usage:
    python train.py --ckpt_dir checkpoints_exp2_down_slot_up_bev
    python train.py --ckpt_dir checkpoints_exp2_down_slot_up_bev --resume checkpoints_exp2_down_slot_up_bev/last.pth
"""
import argparse
import csv
import sys
...
def main():
    ...
    parser.add_argument("--ckpt_dir", default="checkpoints_exp2_down_slot_up_bev")
