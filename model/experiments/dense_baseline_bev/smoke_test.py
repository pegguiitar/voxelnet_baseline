"""smoke_test.py (dense_baseline_bev) - synthetic-data structural test for
DenseBEVVoxelNet (model construction -> forward -> BEV target building
...
def main():
    ...
    print("\nOK -- dense_baseline_bev forward/target/loss/backward/decode all ran without error.")
