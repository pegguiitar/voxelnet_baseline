"""train.py (dense_baseline_bev) - trains DenseBEVVoxelNet.
...
Usage:
    python train.py --ckpt_dir checkpoints_dense_baseline_bev
    python train.py --ckpt_dir checkpoints_dense_baseline_bev --resume checkpoints_dense_baseline_bev/last.pth
"""
import argparse
import csv
import sys
...
from voxelnet import DenseBEVVoxelNet  # noqa: E402
...
def main():
    ...
    parser.add_argument("--ckpt_dir", default="checkpoints_dense_baseline_bev")
    ...
    model = DenseBEVVoxelNet().to(device)
